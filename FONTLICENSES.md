...
Haze bundles the following typefaces, each licensed under the SIL Open Font
License, Version 1.1. The fonts were modified for this app: lining-figure
(`lnum`) OpenType features were frozen in and the fonts renamed with an
"LF" suffix (a Reserved Font Name-compliant rename; neither family reserves
a font name).
