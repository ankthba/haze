...
## Category
Primary: Weather   |   Secondary (optional): Utilities

## Age Rating
4+ (answer "None" to every questionnaire item)

## App Privacy (nutrition label)
- Data: Precise Location (and/or Coarse Location)
- Purpose: App Functionality
- Linked to identity: No   |   Used for tracking: No
(Matches the bundled PrivacyInfo.xcprivacy.)
